...
#ifndef PRIZM_BLOCK_ON_START_BUTTON
#define PRIZM_BLOCK_ON_START_BUTTON 0
#endif

namespace {

constexpr unsigned long kMotorCommandSettleMs = 10;

inline void motorCommandSettle() {
  delay(kMotorCommandSettleMs);
}
...
#if PRIZM_BLOCK_ON_START_BUTTON
...
#else
  delay(40);                            // short settle delay when start-button blocking is disabled
#endif
